...
const AddBlog = () => {
  ...
  return (
    <form className='flex-1 bg-blue-50/50 text-gray-600 h-full oerflow-scroll'>
      <div className='bg-white w-full max-w-3xl p-4 md:p-10 sm:m-10 shadow rounded'>
        ...
        <input type="text" placeholder='Type here' required className='w-full max-w-lg mt-2 p-2 border border-gray-300 outline-none rounded' onChange={e => setSubTitle(e.target.value)} value={setSubTitle}/>
        ...
        <select onChange={e => setCategory(e.target.value)} name="category" className='me-2 px-3 py-2 border text-gray-500 border-gray-300 outline-none rounded'>
